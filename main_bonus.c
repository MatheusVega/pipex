...
/*   Updated: 2021/11/05 22:28:06 by mathfern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	loop(int numbloop, int fdin, char **envp, char **argv)
{
	int		i;
	char	**cmd;
	char	*path;
